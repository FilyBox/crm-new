...
export const StackAvatarArtist = ({ first, zIndex, fallbackText = '' }: StackAvatarProps) => {
  const classes = '';
  let zIndexClass = '';
  ...
  return (
    <Avatar
      className={` ${firstClass} dark:border-border h-10 w-10 border-2 border-solid border-white`}
    >
