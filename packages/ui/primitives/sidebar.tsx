    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className={cn(
            'w-(--sidebar-width) bg-sidebar text-sidebar-foreground border-none p-0 [&>button]:hidden',
            className,
          )}
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) relative bg-transparent transition-[width] duration-300 ease-[cubic-bezier(0.65,0,0.35,1)]',
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] duration-300 ease-[cubic-bezier(0.65,0,0.35,1)] lg:flex',
          side === 'left'
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <PanelLeftIcon className="size-5" size={20} />
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      className={cn(
        'hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-[cubic-bezier(0.65,0,0.35,1)] after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex',
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'lg:peer-data-[variant=inset]:m-2 lg:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 lg:peer-data-[variant=inset]:rounded-2xl lg:peer-data-[variant=inset]:shadow-sm',
        className,
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-300 ease-[cubic-bezier(0.65,0,0.35,1)] focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
