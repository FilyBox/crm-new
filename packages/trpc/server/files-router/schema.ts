...
import { ZFilesManySchema } from '@documenso/lib/types/files';
...
export const ZFindDocumentsRequestSchema = ZFindSearchParamsSchema.extend({
  ...
  orderByColumn: z.enum(['createdAt', 'title', 'id']).optional(),
...
export const ZFindFilesResponseSchema = ZFindResultResponse.extend({
  data: ZFilesManySchema.array(),
});
export type TFindFilesInternalResponse = z.infer<typeof ZFindFilesResponseSchema>;
