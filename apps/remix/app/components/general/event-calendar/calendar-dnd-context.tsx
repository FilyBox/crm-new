import { type ReactNode, createContext, useContext, useId, useRef, useState } from 'react';
...
export function CalendarDndProvider({ children, onEventUpdate }: CalendarDndProviderProps) {
  ...
  const handleDragStart = (event: DragStartEvent) => {
    ...
    setActiveView(view);
    setCurrentTime(new Date(calendarEvent.beginning));
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    try {
      ...
      const originalStart = new Date(calendarEvent.beginning);
