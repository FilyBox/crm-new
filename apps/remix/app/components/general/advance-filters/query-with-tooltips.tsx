...
export function QueryWithTooltips({
  ...
  return (
    <div className="bg-muted overflow-x-auto rounded-lg font-mono">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span className="hover:bg-primary/20 inline-block cursor-help rounded-sm px-1 transition-colors duration-200 ease-in-out">
                    {segment.text}
                  </span>
                </TooltipTrigger>
