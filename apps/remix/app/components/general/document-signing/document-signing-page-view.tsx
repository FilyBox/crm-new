      ...
      <div className="mx-auto w-full max-w-screen-xl sm:px-6">
        ...
        <div className="relative mt-4 flex w-full flex-col gap-x-6 gap-y-8 sm:mt-8 md:flex-row lg:gap-x-8 lg:gap-y-0">
          ...
          <div
            ...
            className="group/document-widget fixed bottom-6 left-0 z-50 h-fit max-h-[calc(100dvh-2rem)] w-full flex-shrink-0 px-4 md:sticky md:bottom-[unset] md:top-20 md:z-auto md:w-[350px] md:px-0"
